---
title: "How to dual boot windows (MBR) and linux and use grub-customizer"
url: https://arcolinux.com/how-to-dual-boot-windows-mbr-and-linux-and-use-grub-customizer/
date: 2018-10-27 17:32:28
type: post
...
# How to dual boot windows (MBR) and linux and use grub-customizer
...
In this tutorial we will **dual boot between Windows 10 (1803) and Linux (ArcoLinuxB-Mate-Minimal)**.
...
You can also **autologin** into **W10** with the use of the application **netplwiz**. We show you how.
